<div class="mkdf-social-login-holder">
    <div class="mkdf-social-login-holder-inner">
        <form method="post" class="mkdf-login-form">
            ...
            <fieldset>
                <div>
                    <input type="text" name="user_login_name" id="user_login_name" placeholder="<?php esc_html_e( 'User Name', 'mkdf-membership' ) ?>" value="" required pattern=".{3,}" title="<?php esc_html_e( 'Three or more characters', 'mkdf-membership' ); ?>"/>
                </div>
                <div>
                    <input type="password" name="user_login_password" id="user_login_password" placeholder="<?php esc_html_e( 'Password', 'mkdf-membership' ) ?>" value="" required/>
                </div>
    ...
    if(mkdf_membership_theme_installed()) {
        ...
        $social_login_enabled = roam_mikado_options()->getOptionValue('enable_social_login') == 'yes' ? true : false;
