...
if ( ! function_exists( 'mkdf_membership_membership_options_map' ) ) {
	function mkdf_membership_membership_options_map( $page ) {
		...
		if ( mkdf_membership_theme_installed() ) {
			...
			$panel_social_login = roam_mikado_add_admin_panel(
				array(
					'page'  => $page,
			...
			$panel_enable_social_login = roam_mikado_add_admin_panel(
				array(
					'page'            => $page,
			...
			$enable_facebook_social_login_container = roam_mikado_add_admin_container(
				array(
			...
			$enable_google_social_login_container = roam_mikado_add_admin_container(
				array(
	...
	add_action( 'roam_mikado_social_options', 'mkdf_membership_membership_options_map' );
}
