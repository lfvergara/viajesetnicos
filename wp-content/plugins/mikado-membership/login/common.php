	...
	function mkdf_membership_set_social_vars() {
		...
		if ( $social_login_enabled ) {
			...
			$social_variables = array(
				'facebookAppId'  => roam_mikado_options()->getOptionValue( 'enable_facebook_social_login' ) == 'yes' ? roam_mikado_options()->getOptionValue( 'enable_facebook_login_fbapp_id' ) : null,
				'googleClientId' => roam_mikado_options()->getOptionValue( 'enable_google_social_login' ) == 'yes' ? roam_mikado_options()->getOptionValue( 'enable_google_login_client_id' ) : null
			);
