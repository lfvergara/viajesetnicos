...
<div class="mkdf-meta-box mkdf-page">
	...
	<div class="mkdf-meta-box-holder">
			...
			?>
				...
				?>
					<div class="mkdf-tour-booking-section" data-index="<?php echo esc_attr($i); ?>">
						...
						<div class="row">
							<a href="#" class="mkdf-tour-booking-remove-item dashicons dashicons-no-alt" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Section', 'mkdf-tours'); ?>"></a>
							<div class="col-sm-4">
								<div class="row">
									<div class="col-sm-12">
										<h4><?php esc_html_e('Tour Date and Days', 'mkdf-tours'); ?></h4>
										<div class="form-group">
											<label for="tour_booking[<?php echo esc_attr($i); ?>][start_date]"><?php esc_html_e('Start Date:', 'mkdf-tours'); ?></label>
										...
										<div class="form-group">
											<label for="tour_booking[<?php echo esc_attr($i); ?>][end_date]"><?php esc_html_e('End Date:', 'mkdf-tours'); ?></label>
							...
							<div class="col-sm-4">
								<h4><?php esc_html_e('Departure Times', 'mkdf-tours'); ?></h4>
									...
									<?php if(!empty($rowObject->times) && is_array($rowObject->times) && count($rowObject->times)) : ?>
										...
										<?php foreach($rowObject->times as $time) : ?>
											<div class="mkdf-tour-booking-time" data-index="<?php echo esc_attr($j); ?>">
												...
												<a href="#" title="<?php esc_html_e('Remove Time', 'mkdf-tours'); ?>" class="mkdf-tour-booking-time-remove dashicons dashicons-no-alt form-control-feedback" aria-hidden="true"></a>
											</div>
											<?php $j++; ?>
										<?php endforeach; ?>
									<?php endif; ?>
								</div>
								<a href="#" class="btn btn-primary mkdf-tour-booking-time-add" id="mkdf-tour-booking-time-add-<?php echo esc_attr($i); ?>"><?php esc_html_e('Add New Time','mkdf-tours'); ?></a>
							</div>
							<div class="col-sm-4">
								<h4><?php esc_html_e('Details', 'mkdf-tours'); ?></h4>
								<div class="form-group">
									<label for="tour_booking[<?php echo esc_attr($i); ?>][number_of_tickets]"><?php esc_html_e('Tickets', 'mkdf-tours'); ?></label>
								...
								<div class="form-group">
									<label for="tour_booking[<?php echo esc_attr($i); ?>][price_change]"><?php esc_html_e('Price change', 'mkdf-tours'); ?></label>
									...
									<p class="help-block"><?php esc_html_e('Use this field for defining special price for this period. Use "%" in front of the number to change the price in percentage.', 'mkdf-tours'); ?></p>
								</div>
							</div>
						</div>
		...
		<div class="mkdf-tour-booking-controls">
			<a id="mkdf-tour-booking-add" href="#" class="btn btn-primary"><?php esc_html_e('Add New Period', 'mkdf-tours'); ?></a>
			<a id="mkdf-tour-booking-save" href="#" class="btn btn-primary" data-loading-label="<?php esc_html_e('Saving...', 'mkdf-tours'); ?>"><?php esc_html_e('Save', 'mkdf-tours') ?></a>
		</div>
			...
			<div class="mkdf-tour-booking-section" data-index="{{{ data.rowIndex }}}">
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="row">
							<div class="col-sm-12">
								<h4><?php esc_html_e('Tour Date and Days', 'mkdf-tours'); ?></h4>
								<div class="form-group">
									<label for="tour_booking[{{{ data.rowIndex }}}][start_date]"><?php esc_html_e('Start Date:', 'mkdf-tours'); ?></label>
								...
								<div class="form-group">
									<label for="tour_booking[{{{ data.rowIndex }}}][end_date]"><?php esc_html_e('End Date:', 'mkdf-tours'); ?></label>
					...
					<div class="col-sm-4">
						...
						<a href="#" class="btn btn-primary mkdf-tour-booking-time-add" id="mkdf-tour-booking-time-add-{{{ data.rowIndex }}}"><?php esc_html_e('Add New Time', 'mkdf-tours'); ?></a>
					</div>
					<div class="col-sm-4">
						<h4><?php esc_html_e('Details', 'mkdf-tours'); ?></h4>
						<div class="form-group">
							<label for="tour_booking[{{{ data.rowIndex }}}][number_of_tickets]"><?php esc_html_e('Tickets', 'mkdf-tours'); ?></label>
							<input type="text" name="tour_booking[{{{ data.rowIndex }}}][number_of_tickets]" class="form-control mkdf-input mkdf-form-element">
						</div>
						<div class="form-group">
							<label for="tour_booking[{{{ data.rowIndex }}}][price_change]"><?php esc_html_e('Price change', 'mkdf-tours'); ?></label>
