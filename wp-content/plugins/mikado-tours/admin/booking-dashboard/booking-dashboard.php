...
class BookingSubmenuPage {
	...
	public function mkdfToursSendApproveEmal($booking_id, $status) {
		...
		if ( $status == 'approve' ) {
			$subject  = esc_html__('La información de reserva para', 'mkdf-tours') . ' '. $tour_title . ' '. esc_html__('de', 'mkdf-tours') . ' ' . $name .' '. esc_html__('ha sido confirmada', 'mkdf-tours');
			$message = esc_html__('Hemos recibido con éxito su pago para','mkdf-tours') .  ' '. $tour_title . ' '. esc_html__('de', 'mkdf-tours') . ' ' . $name;
		} elseif ( $status == 'cancel' ) {
			$subject  = esc_html__('La información de reserva para', 'mkdf-tours') . ' '. $tour_title . ' '. esc_html__('de', 'mkdf-tours') . ' ' . $name .' '. esc_html__('ha sido cancelada', 'mkdf-tours');
			$message = esc_html__('Se produjo un error con su pago de','mkdf-tours') .  ' '. $tour_title . ' '. esc_html__('de', 'mkdf-tours') . ' ' . $name .' '. esc_html__('.Póngase en contacto con el administrador para obtener más información.', 'mkdf-tours');
		}
