...
class ToursBookingTable extends WP_List_Table {
	...
	public function column_default($item, $column_name) {
		switch($column_name) {
			...
			case 'amount':
				...
				$amountLabel = $amount === 1 ? esc_html__('persona', 'mkdf-tours') : esc_html__('personas', 'mkdf-tours');
			...
			case 'actions':
				...
				$buttons = array(
					'approved' => '<a href="#" class="mkdf-booking-table-action-btn approve-booking" data-booking-id="'.$item_id.'" title="'.esc_html__('Aprobar', 'mkdf-tours').'"><i class="dashicons dashicons-yes"></i></a>',
					'canceled' => '<a href="#" class="mkdf-booking-table-action-btn cancel-booking" data-booking-id="'.$item_id.'" title="'.esc_html__('Cancelar', 'mkdf-tours').'"><i class="dashicons dashicons-no-alt"></i></a>'
				);
	...
	function get_columns() {
		$columns = array(
			...
			'booking_info'   => esc_html__('Información reserva', 'mkdf-tours'),
			'tour_id'        => esc_html__('Nombre del tour', 'mkdf-tours'),
			'booking_date'   => esc_html__('Fecha', 'mkdf-tours'),
			'amount'         => esc_html__('Cantidad', 'mkdf-tours'),
			'price'          => esc_html__('Precio', 'mkdf-tours'),
			'status'         => esc_html__('Estado de la reserva', 'mkdf-tours'),
			'payment_status' => esc_html__('Estado del pago', 'mkdf-tours'),
			'user_message'   => esc_html__('Mensaje del usuario', 'mkdf-tours'),
			'actions'        => esc_html__('Acciones', 'mkdf-tours'),
		);
