...
<div class="mkdf-tour-booking-form-holder mkdf-boxed-widget">
	...
	<form id="mkdf-tour-booking-form" method="POST">
		...
		<div class="mkdf-tour-booking-field-holder mkdf-tours-input-with-icon">
			...
			<select class="mkdf-tours-select-placeholder mkdf-tours-select-default-option" name="number_of_tickets">
				<option value="">¿Con quién viajas?</option>
				<option value="Solo-Sola">Solo/Sola</option>
				<option value="En pareja">En pareja</option>
				<option value="En familia">En familia</option>
				<option value="Entre amigos">Entre amigos</option>
				<option value="Rusia y Asia Central">Rusia y Asia Central</option>
				<option value="En un grupo">En un grupo</option>
			</select>
