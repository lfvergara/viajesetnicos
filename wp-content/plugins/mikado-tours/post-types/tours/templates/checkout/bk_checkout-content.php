			...
			<div class="mkdf-tours-checkout-content-inner">
				...
				<div class="mkdf-tours-info-holder">
					...
					<h5 class="mkdf-tours-info-message">
						<?php esc_html_e('Has realizado una petición de información para reservar ','mkdf-tours'); print $booking->amount; esc_html_e(' persona(s) para ','mkdf-tours'); echo get_the_title($booking->ID); ?>
					</h5>
					...
					<div>
						<h6 class="mkdf-tours-info-checkout-title"><?php esc_html_e('Fecha de salida:', 'mkdf-tours'); ?></h6>
						<span><?php echo esc_html(date(get_option('date_format'), strtotime($booking->booking_date))); ?></span>
					</div>
					<div>
						<h6 class="mkdf-tours-info-checkout-title"><?php esc_html_e('Precio total:', 'mkdf-tours'); ?></h6>
