...
class TourPriceHelper {
	...
	public function getCurrencySymbol() {
		...
		$symbol = roam_mikado_options()->getOptionValue('tours_currency_symbol');
	...
	public function getCurrencyPosition() {
		...
		$position = roam_mikado_options()->getOptionValue('tours_currency_symbol_position');
	...
	public function getMinPrice() {
		$mikadoPrices = $this->getMikadoPrices();

		if(!$mikadoPrices) {
			return false;
		}

		return $mikadoPrices->min_price;
	}
	...
	public function getMaxPrice() {
		...
		return $mikadoPrices->max_price;
	}

	/**
	 * @return array|bool|null|object
	 */
	public function getMikadoPrices() {
		global $wpdb;
