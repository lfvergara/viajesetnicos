...
class TablesSetup {
	...
	public function initialize() {
		...
		register_activation_hook(MIKADO_TOURS_MAIN_FILE_PATH, array($this, 'onActivate'));
		register_deactivation_hook(MIKADO_TOURS_MAIN_FILE_PATH, array($this, 'onDeactivate'));
