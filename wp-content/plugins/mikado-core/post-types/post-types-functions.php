...
if(!function_exists('mkdf_core_include_custom_post_types_meta_boxes')) {
	...
	add_action('roam_mikado_before_meta_boxes_map', 'mkdf_core_include_custom_post_types_meta_boxes');
}
...
if(!function_exists('mkdf_core_include_custom_post_types_global_options')) {
	...
	add_action('roam_mikado_before_options_map', 'mkdf_core_include_custom_post_types_global_options', 1);
}