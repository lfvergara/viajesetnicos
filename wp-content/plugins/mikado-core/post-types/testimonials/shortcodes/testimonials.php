...
class Testimonials implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array_flip( roam_mikado_get_yes_no_select_array( false, false ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'mkdf-core' )
						),
						array(
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="mkdf-testimonials-holder ' . $holder_classes . ' clearfix">';
			$html .= '<div class="mkdf-testimonials mkdf-owl-slider" ' . roam_mikado_get_inline_attrs( $data_attr ) . '>';
