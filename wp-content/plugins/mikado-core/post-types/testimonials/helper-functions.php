...
if ( ! function_exists( 'mkdf_core_testimonials_meta_box_functions' ) ) {
	...
	add_filter( 'roam_mikado_meta_box_post_types_save', 'mkdf_core_testimonials_meta_box_functions' );
	add_filter( 'roam_mikado_meta_box_post_types_remove', 'mkdf_core_testimonials_meta_box_functions' );
}
