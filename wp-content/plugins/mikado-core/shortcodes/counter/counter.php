...
class Counter implements Lib\ShortcodeInterface {
			...
			vc_map(
				array(
					...
					'params'                    => array(
                        ...
                        array(
                            'type'       => 'textfield',
                            'heading'    => esc_html__('Symbol', 'mkdf-core'),
                            'param_name' => 'symbol',
                        ),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit_font_size',
							'heading'    => esc_html__( 'Digit and Symbol Font Size (px)', 'mkdf-core' ),
							'dependency' => array( 'element' => 'digit', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'digit_color',
							'heading'    => esc_html__( 'Digit and Symbol Color', 'mkdf-core' ),
							'dependency' => array( 'element' => 'digit', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
	...
	private function getCounterStyles( $params ) {
		...
		if ( ! empty( $params['digit_font_size'] ) ) {
			$styles[] = 'font-size: ' . roam_mikado_filter_px( $params['digit_font_size'] ) . 'px';
		}
