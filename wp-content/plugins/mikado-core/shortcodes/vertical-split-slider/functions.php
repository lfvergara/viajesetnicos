...
if ( ! function_exists( 'mkdf_core_enqueue_scripts_for_vertical_split_slider_shortcodes' ) ) {
	/**
	 * Function that includes all necessary 3rd party scripts for this shortcode
	 */
	function mkdf_core_enqueue_scripts_for_vertical_split_slider_shortcodes() {
	...
	add_action( 'roam_mikado_enqueue_third_party_scripts', 'mkdf_core_enqueue_scripts_for_vertical_split_slider_shortcodes' );
}
...
if ( ! function_exists( 'mkdf_core_add_vertical_split_screen_slider_shortcodes' ) ) {
	function mkdf_core_add_vertical_split_screen_slider_shortcodes( $shortcodes_class_name ) {
		$shortcodes = array(
	...
	add_filter( 'mkdf_core_filter_add_vc_shortcode', 'mkdf_core_add_vertical_split_screen_slider_shortcodes' );
}

if ( ! function_exists( 'mkdf_core_set_vertical_split_slider_custom_style_for_vc_shortcodes' ) ) {
	/**
	 * Function that set custom css style for vertical split slider shortcode
	 */
	function mkdf_core_set_vertical_split_slider_custom_style_for_vc_shortcodes( $style ) {
	...
	add_filter( 'mkdf_core_filter_add_vc_shortcodes_custom_style', 'mkdf_core_set_vertical_split_slider_custom_style_for_vc_shortcodes' );
}

if ( ! function_exists( 'mkdf_core_set_vertical_split_slider_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	 ...
	 */
	function mkdf_core_set_vertical_split_slider_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
	...
	add_filter( 'mkdf_core_filter_add_vc_shortcodes_custom_icon_class', 'mkdf_core_set_vertical_split_slider_icon_class_name_for_vc_shortcodes' );
}