...
class CustomFont implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array_flip( roam_mikado_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array_flip( roam_mikado_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( roam_mikado_string_ends_with( $params['font_size'], 'px' ) || roam_mikado_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( roam_mikado_string_ends_with( $params['line_height'], 'px' ) || roam_mikado_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( roam_mikado_string_ends_with( $params['letter_spacing'], 'px' ) || roam_mikado_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1280'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['font_size_1280'], 'px' ) || roam_mikado_string_ends_with( $params['font_size_1280'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['font_size_1024'], 'px' ) || roam_mikado_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['font_size_768'], 'px' ) || roam_mikado_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['font_size_680'], 'px' ) || roam_mikado_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1280'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['line_height_1280'], 'px' ) || roam_mikado_string_ends_with( $params['line_height_1280'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['line_height_1024'], 'px' ) || roam_mikado_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['line_height_768'], 'px' ) || roam_mikado_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( roam_mikado_string_ends_with( $params['line_height_680'], 'px' ) || roam_mikado_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="mkdf-cf-typed-wrap" ' . roam_mikado_get_inline_style( $typed_styles ) . '><span class="mkdf-cf-typed">';
