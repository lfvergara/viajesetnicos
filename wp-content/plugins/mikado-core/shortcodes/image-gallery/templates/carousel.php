...
<div class="mkdf-image-gallery <?php echo esc_attr($holder_classes); ?>">
	<div class="mkdf-ig-slider mkdf-owl-slider" <?php echo roam_mikado_get_inline_attrs($slider_data); ?>>
			...
			<div class="mkdf-ig-image">
				...
				<?php } ?>
					<?php if(is_array($image_size) && count($image_size)) :
						echo roam_mikado_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
					else:
