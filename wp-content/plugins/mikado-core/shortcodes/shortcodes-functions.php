...
if ( ! function_exists( 'mkdf_core_add_admin_shortcodes_styles' ) ) {
	...
	add_action( 'roam_mikado_admin_scripts_init', 'mkdf_core_add_admin_shortcodes_styles' );
}
...
if ( ! function_exists( 'mkdf_core_add_admin_shortcodes_custom_styles' ) ) {
	...
	add_action( 'roam_mikado_admin_scripts_init', 'mkdf_core_add_admin_shortcodes_custom_styles' );
}