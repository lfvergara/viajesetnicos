<?php
if ( ! function_exists( 'roam_mikado_init_google_fonts_array' ) ) {
    function roam_mikado_init_google_fonts_array() {
        ...
        $google_fonts_json = '
        {
         ...
         "items": [
          ...
          },
          {
           ...
           "lastModified": "2016-05-31",
           "files": {
            "regular": "http://fonts.gstatic.com/s/lmikador/v4/G432jp-tahOfWHbCYkI0jw.ttf"
           }
          },
          {
           "kind": "webfonts#webfont",
        ...
        $roam_mikado_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'roam_mikado_init_google_fonts_array');
}