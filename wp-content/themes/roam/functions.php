...
if ( ! function_exists( 'roam_mikado_styles' ) ) {
	...
	function roam_mikado_styles() {
		...
		wp_enqueue_style( 'roam_mikado_default_style', MIKADO_ROOT . '/style.css' );
		wp_enqueue_style( 'roam_mikado_modules', MIKADO_ASSETS_ROOT . '/css/modules.min.css' );
		...
		if ( roam_mikado_is_woocommerce_installed() && roam_mikado_load_woo_assets() ) {
			...
			wp_enqueue_style( 'roam_mikado_woo', MIKADO_ASSETS_ROOT . '/css/woocommerce.min.css' );
		}
		...
		if ( roam_mikado_load_woo_assets() ) {
			$style_dynamic_deps_array = array( 'roam_mikado_woo', 'roam_mikado_woo_responsive' );
		}
		
		if ( file_exists( MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css' ) && roam_mikado_is_css_folder_writable() && ! is_multisite() ) {
			wp_enqueue_style( 'roam_mikado_style_dynamic', MIKADO_ASSETS_ROOT . '/css/style_dynamic.css', $style_dynamic_deps_array, filemtime( MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css' ) ); //it must be included after woocommerce styles so it can override it
			...
			wp_enqueue_style( 'roam_mikado_style_dynamic', MIKADO_ASSETS_ROOT . '/css/style_dynamic_ms_id_' . roam_mikado_get_multisite_blog_id() . '.css', $style_dynamic_deps_array, filemtime( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_ms_id_' . roam_mikado_get_multisite_blog_id() . '.css' ) ); //it must be included after woocommerce styles so it can override it
		}
		
		//is responsive option turned on?
		if ( roam_mikado_is_responsive_on() ) {
			wp_enqueue_style( 'roam_mikado_modules_responsive', MIKADO_ASSETS_ROOT . '/css/modules-responsive.min.css' );
			
			//is woocommerce installed?
			if ( roam_mikado_is_woocommerce_installed() && roam_mikado_load_woo_assets() ) {
				//include theme's woocommerce responsive styles
				wp_enqueue_style( 'roam_mikado_woo_responsive', MIKADO_ASSETS_ROOT . '/css/woocommerce-responsive.min.css' );
			}
			...
			if ( file_exists( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css' ) && roam_mikado_is_css_folder_writable() && ! is_multisite() ) {
				wp_enqueue_style( 'roam_mikado_style_dynamic_responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive.css', array(), filemtime( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css' ) );
				...
				wp_enqueue_style( 'roam_mikado_style_dynamic_responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive_ms_id_' . roam_mikado_get_multisite_blog_id() . '.css', array(), filemtime( MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive_ms_id_' . roam_mikado_get_multisite_blog_id() . '.css' ) );
			}
		}
	}
...
if ( ! function_exists( 'roam_mikado_google_fonts_styles' ) ) {
	...
	function roam_mikado_google_fonts_styles() {
		...
		if ( count( $fonts_array ) > 0 ) {
			...
			wp_enqueue_style( 'roam_mikado_google_fonts', esc_url_raw( $roam_mikado_fonts ), array(), '1.0.0' );
...
if ( ! function_exists( 'roam_mikado_scripts' ) ) {
	...
	function roam_mikado_scripts() {
		...
		wp_enqueue_script( 'roam_mikado_appear', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.appear.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_modernizr', MIKADO_ASSETS_ROOT . '/js/modules/plugins/modernizr.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_hoverIntent', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.hoverIntent.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_jquery-plugin', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.plugin.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_owl-carousel', MIKADO_ASSETS_ROOT . '/js/modules/plugins/owl.carousel.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_waypoints', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.waypoints.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_chart', MIKADO_ASSETS_ROOT . '/js/modules/plugins/Chart.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_fluidvids', MIKADO_ASSETS_ROOT . '/js/modules/plugins/fluidvids.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_prettyphoto', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.prettyPhoto.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_nicescroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.nicescroll.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_ScrollToPlugin', MIKADO_ASSETS_ROOT . '/js/modules/plugins/ScrollToPlugin.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_parallax', MIKADO_ASSETS_ROOT . '/js/modules/plugins/parallax.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_waitforimages', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.waitforimages.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_jquery-easing-1.3', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.easing.1.3.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_isotope', MIKADO_ASSETS_ROOT . '/js/modules/plugins/isotope.pkgd.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'roam_mikado_packery', MIKADO_ASSETS_ROOT . '/js/modules/plugins/packery-mode.pkgd.min.js', array( 'jquery' ), false, true );
		...
		if ( roam_mikado_is_page_smooth_scroll_enabled() ) {
			wp_enqueue_script( 'roam_mikado_tweenLite', MIKADO_ASSETS_ROOT . '/js/modules/plugins/TweenLite.min.js', array( 'jquery' ), false, true );
			wp_enqueue_script( 'roam_mikado_smoothPageScroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/smoothPageScroll.js', array( 'jquery' ), false, true );
		}
		...
		if ( ! empty( $google_maps_api_key ) ) {
			wp_enqueue_script( 'roam_mikado_google_map_api', '//maps.googleapis.com/maps/api/js?key=' . esc_attr( $google_maps_api_key ).$google_maps_extensions, array(), false, true );
		}
		
		wp_enqueue_script( 'roam_mikado_modules', MIKADO_ASSETS_ROOT . '/js/modules.min.js', array( 'jquery' ), false, true );
...
if ( ! function_exists( 'roam_mikado_print_custom_css' ) ) {
	...
	function roam_mikado_print_custom_css() {
		...
		if ( ! empty( $custom_css ) ) {
			wp_add_inline_style( 'roam_mikado_modules', $custom_css );
		}
	}
...
if ( ! function_exists( 'roam_mikado_page_custom_style' ) ) {
	...
	function roam_mikado_page_custom_style() {
		...
		if ( $style !== '' ) {
			...
			if ( roam_mikado_is_woocommerce_installed() && roam_mikado_load_woo_assets() ) {
				wp_add_inline_style( 'roam_mikado_woo', $style );
			} else {
				wp_add_inline_style( 'roam_mikado_modules', $style );
			}
		}
	}
...
if ( ! function_exists( 'roam_mikado_get_global_variables' ) ) {
	...
	function roam_mikado_get_global_variables() {
		...
		wp_localize_script( 'roam_mikado_modules', 'mkdfGlobalVars', array(
...
if ( ! function_exists( 'roam_mikado_per_page_js_variables' ) ) {
	...
	function roam_mikado_per_page_js_variables() {
		...
		wp_localize_script( 'roam_mikado_modules', 'mkdfPerPageVars', array(
