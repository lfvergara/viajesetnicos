...
if(!function_exists('roam_mikado_meta_box_add')) {
	...
	add_action('add_meta_boxes', 'roam_mikado_meta_box_add');
}
        ...
        <li <?php comment_class(); ?>>
	        <div class="<?php echo esc_attr($comment_class); ?>">
	            ...
	            <div class="mkdf-comment-text">
	                ...
	                <?php } ?>
					<?php
					comment_reply_link( array_merge( $args, array('reply_text' => esc_html__('Respuesta', 'roam'), 'depth' => $depth, 'max_depth' => $args['max_depth'])));
...
if ( ! function_exists( 'roam_mikado_tax_add_script' ) ) {
	function roam_mikado_tax_add_script() {
		wp_enqueue_media();
		wp_enqueue_script( 'mkdf-media-js', MIKADO_FRAMEWORK_ROOT . '/admin/assets/js/mkdf-tax-media-upload.js' );
	}
