                        ...
                        <div class="col-lg-12">
                            <div class="mkdf-media-uploader">
                                <div<?php if (!$has_value) { ?> style="display: none"<?php } ?>
                                    ...
                                    <img src="<?php if ($has_value) { echo esc_url(roam_mikado_option_get_uploaded_file_icon($value)); } ?>" alt=""
                                ...
                                <a class="mkdf-media-upload-btn btn btn-sm btn-primary"
                                   ...
                                   data-frame-title="<?php esc_html_e('Select File', 'roam'); ?>"
                                   data-frame-button-text="<?php esc_html_e('Select File', 'roam'); ?>"><?php esc_html_e('Upload', 'roam'); ?></a>
