						...
						<div class="col-lg-12">
							<div class="mkdf-media-uploader">
								<div<?php if (!roam_mikado_option_has_value($name)) { ?> style="display: none"<?php } ?> class="mkdf-media-image-holder">
									<img src="<?php if (roam_mikado_option_has_value($name)) { echo esc_url(roam_mikado_get_attachment_thumb_url(roam_mikado_option_get_value($name))); } ?>" alt="" class="mkdf-media-image img-thumbnail" />
								</div>
