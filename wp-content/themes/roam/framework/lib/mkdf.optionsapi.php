 ...
 */
if ( ! function_exists( 'roam_mikado_add_meta_box' ) ) {
	/**
	 * Adds new meta box
	 *
	 * @param $attributes
	 ...
	 */
	function roam_mikado_add_meta_box( $attributes ) {
		$scope           = array();
		$title           = '';
		$hidden_property = '';
		$hidden_values   = array();
...
if ( ! function_exists( 'roam_mikado_add_meta_box_field' ) ) {
	/**
	 ...
	 * @return bool|RoamMikadoField
	 */
	function roam_mikado_add_meta_box_field( $attributes ) {
		$type            = '';
		$name            = '';
		$default_value   = '';
		$label           = '';
