							...
							<div class="mkdf-tours-search-main-filters-fields">
								...
								<div class="mkdf-tours-input-with-icon" style="margin-bottom: 0px;">
									...
									<select class="mkdf-tours-select-placeholder" name="destination">
										...
										<option value="Latinoamérica"><?php //esc_html_e('Latinoamérica', 'mkdf-tours'); ?></option>
										<option value="Oriente Próximo"><?php //esc_html_e('Oriente Próximo', 'mkdf-tours'); ?></option>
										...
										<option value="Sudeste+Asiático"><?php //esc_html_e('Sudeste Asiático', 'mkdf-tours'); ?></option>
										<option value="Oceanía"><?php //esc_html_e('Oceanía', 'mkdf-tours'); ?></option>
										<option value="Norte+de+África"><?php //esc_html_e('Norte de África', 'mkdf-tours'); ?></option>
										<option value="África+Negra"><?php //esc_html_e('África Negra', 'mkdf-tours'); ?></option>
										<option value="Norteamérica"><?php //esc_html_e('Norteamérica', 'mkdf-tours'); ?></option>
										-->
									</select>
								</div>
