							...
							<?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
								...
								<li>
									...
									<div class="mkdf-item-info-holder">
										...
										<?php echo apply_filters( 'roam_mikado_woo_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s"><span class="ion-close"></span></a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__('Remove this item', 'roam') ), $cart_item_key ); ?>
									</div>
								</li>
							<?php endforeach; ?>
...
add_action('widgets_init', function () {
    register_widget( "RoamMikadoWoocommerceDropdownCart" );
});
