...
if ( ! function_exists( 'roam_mikado_load_widget_class' ) ) {
	/**
	 * Loades widget class file.
	 */
	function roam_mikado_load_widget_class() {
		include_once MIKADO_FRAMEWORK_MODULES_ROOT_DIR . '/widgets/lib/widget-class.php';
	}
	
	add_action( 'roam_mikado_before_options_map', 'roam_mikado_load_widget_class' );
}

if ( ! function_exists( 'roam_mikado_load_widgets' ) ) {
	/**
	 * Loades all widgets by going through all folders that are placed directly in widgets folder
	 * and loads load.php file in each. Hooks to roam_mikado_after_options_map action
	 */
	function roam_mikado_load_widgets() {
	...
	add_action( 'roam_mikado_before_options_map', 'roam_mikado_load_widgets' );
}