		...
		<div class="mkdf-blog-single-navigation-inner clearfix">
			...
			if(get_previous_post() !== ""){
				...
				if($prev_post_thumbnail != '') {
					$post_navigation['prev']['image'] = '<img class="mkdf-nav-image" src="'.esc_url($prev_post_thumbnail).'" alt="">';
				}
			}
			if(get_next_post() != ""){
				if($blog_navigation_through_same_category){
				...
				if($next_post_thumbnail != '') {
					$post_navigation['next']['image'] = '<img class="mkdf-nav-image" src="'.esc_url($next_post_thumbnail).'" alt="">';
				}
			}
